package com.metehanbolat.core.presentation.util
...
inline fun <T : ViewBinding> ViewGroup.adapterViewBinding(
    crossinline bindingInflater: (LayoutInflater, ViewGroup?, Boolean) -> T
) = bindingInflater.invoke(LayoutInflater.from(this.context), this, false)
...
fun <T : ViewBinding> Fragment.inflate(viewBindingFactory: (View) -> T) =
